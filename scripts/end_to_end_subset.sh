...
python data_processing/clean_base_outputs.py \
    ...
    --output_file ./generated_data/generations_full_cleaned.jsonl \
    --cleaner_model Qwen/Qwen3-4B-Instruct-2507 \
    --max_new_tokens 1024
...
python data_processing/filter.py \
    --input_file ./generated_data/generations_full_cleaned.jsonl \
    --output_file ./filtered_data/skywork-filtered.jsonl \
    --safety judge \
    --instruct skywork \
    --scorer skywork \
    --threshold 0.15
...
INPUT="filtered_data/skywork-filtered.jsonl"
MODEL="openai"
...
python data_processing/score_diversity.py \
    ...
    --output_file scored_data/skywork_openai_maxsim.jsonl

echo "==================== END: DIVERSITY SCORING ==============="

echo "==================== START: PAIR SELECTION ================"
python data_processing/select_pairs.py \
    --input_file scored_data/skywork_openai_maxsim.jsonl \
    --output_file preference_data/pairs.jsonl \
    --epsilon 6.0
